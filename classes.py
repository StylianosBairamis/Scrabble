...
class FileHandler:
    """
    Η κλάση FileHandler διαχειρίζεται την ανάγνωση και την εγγραφή παιχνιδιών σε ένα αρχείο JSON.

    Attributes:
    games (list): Η λίστα παιχνιδιών που διαχειρίζεται ο FileHandler.
    """
    def __init__(self):
        """
                Αρχικοποιεί τον FileHandler και φορτώνει τα παιχνίδια από το αρχείο "games.json".
                Εάν το αρχείο δεν υπάρχει, δημιουργεί μια κενή λίστα για τα παιχνίδια.
        """
        try:
    ...
    def add_game(self, moves_played, winner, player_score, computer_score):
        """
                Προσθέτει ένα νέο παιχνίδι στη λίστα των παιχνιδιών.
        """
        game = {
            "id": str(uuid.uuid4()),
    ...
    def write_games(self):
        """
                Αποθηκεύει τα παιχνίδια από τη λίστα στο αρχείο "games.json".
